...
A tour of the model. The authoritative design is [the spec](../pattern-engine-spec.md);
...
> [`graph.ts`](../packages/core/src/graph.ts).

## The scheduler

[`scheduler/run.ts`](../packages/core/src/scheduler/run.ts) launches every node of
...
The boundary **contracts** live in core ([`boundaries/`](../packages/core/src/boundaries/index.ts));
