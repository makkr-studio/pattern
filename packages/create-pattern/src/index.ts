...
const AI_PROVIDERS: AiProviderChoice[] = [
  { value: "@ai-sdk/xai", label: "xAI Grok", hint: "", range: "^3", seed: { provider: "xai", envKey: "XAI_API_KEY", language: "grok-4.5" } },
  { value: "@ai-sdk/vercel", label: "Vercel", hint: "v0 models", range: "^2" },
  { value: "@ai-sdk/openai", label: "OpenAI", hint: "", range: "^3", seed: { provider: "openai", envKey: "OPENAI_API_KEY", language: "gpt-5.6-terra", embedding: "text-embedding-3-small" } },
  { value: "@ai-sdk/azure", label: "Azure OpenAI", hint: "OpenAI on Azure", range: "^3" },
  { value: "@ai-sdk/anthropic", label: "Anthropic", hint: "", range: "^3", seed: { provider: "anthropic", envKey: "ANTHROPIC_API_KEY", language: "claude-sonnet-5" } },
  ...
  { value: "@ai-sdk/google", label: "Google Generative AI", hint: "Gemini", range: "^3", seed: { provider: "google", envKey: "GOOGLE_GENERATIVE_AI_API_KEY", language: "gemini-3.5-flash", embedding: "gemini-embedding-001" } },
  ...
  { value: "@ai-sdk/voyage", label: "Voyage AI", hint: "embeddings", range: "^1", seed: { provider: "voyage", envKey: "VOYAGE_API_KEY", embedding: "voyage-4" } },
