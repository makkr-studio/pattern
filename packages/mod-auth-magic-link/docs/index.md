...
the signup policy, the login page); this mod owns the *flow* of requesting
a link.
...
subscriber, the link **prints to the server console**, the zero-config dev
login: nothing to wire, same code path as production.
