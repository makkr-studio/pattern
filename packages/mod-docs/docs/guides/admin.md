...
| Section | What |
|-------|------|
| **Home** | The setup board — every installed mod's checklist ("from zero to your first payment") ticking itself live — then the morning glance: runs and errors in the window, recent failures one click from their run, users and paying customers when those mods are present. |
