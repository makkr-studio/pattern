    ...
    <section id="top" className="relative flex min-h-[94vh] items-center justify-center overflow-hidden px-6">
      ...
      >
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-muted">
          ...
          workflows with you. And when a run fails after the payment went out, you resume it — completed steps never run twice, and anything uncertain waits for your call.
        </p>
