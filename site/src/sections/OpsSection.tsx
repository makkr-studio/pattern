...
export function OpsSection() {
  return (
    <SectionShell
      ...
      subtitle="An op is a typed unit of work with named input and output ports. Pattern ships 175 in the base catalog — 369 with the first-party mods — and writing your own is a small TypeScript file."
    >
