...
export function OpsSection() {
  return (
    <SectionShell
      ...
      subtitle="An op is a typed unit of work with named input and output ports. Pattern ships around 270 of them, and writing your own is a small TypeScript file."
    >
